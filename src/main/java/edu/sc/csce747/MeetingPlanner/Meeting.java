...
public class Meeting {
     ...
     */
    public Meeting() {
        this(1, 1, 0, 23, new ArrayList<>(), new Room("DefaultRoom"), "No Description");
    }
    ...
    public Meeting(int month, int day) {
        this(month, day, 0, 23, new ArrayList<>(), new Room("DefaultRoom"), "No Description");
    }
    ...
    public Meeting(int month, int day, String description) {
        this(month, day, 0, 23, new ArrayList<>(), new Room("DefaultRoom"),
    ...
    public Meeting(int month, int day, int start, int end) {
        this(month, day, start, end, new ArrayList<>(), new Room("DefaultRoom"), "No Description");
    }
    ...
    public Meeting(int month, int day, int start, int end, ArrayList<Person> attendees, Room room, String description) {
        ...
        this.room = (room != null) ? room : new Room("DefaultRoom");
